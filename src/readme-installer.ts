...
이 폴더는 [VoxNote](https://github.com/Moonjuun/obsidian-deepgram-stt) 플러그인이 자동 생성한 작업 공간입니다. **사용 중 자주 보는 기능 가이드는 같은 폴더의 [[FEATURES]] 파일에 모아두었습니다.**
...
![VoxNote 우클릭 서브메뉴 (예시: 마크다운 노트의 재요약 메뉴)](https://raw.githubusercontent.com/Moonjuun/obsidian-deepgram-stt/main/img/img4.webp)
...
This folder is the auto-created workspace for the [VoxNote](https://github.com/Moonjuun/obsidian-deepgram-stt) plugin. **Day-to-day feature guides live in [[FEATURES]] in this same folder.**
...
![VoxNote right-click submenu (example shows the re-summarize menu on a markdown note)](https://raw.githubusercontent.com/Moonjuun/obsidian-deepgram-stt/main/img/img4.webp)
